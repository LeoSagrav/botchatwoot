...
// === CREAR O ACTUALIZAR CONTACTO (✅ FIX: Refresh para obtener contact_inboxes) ===
async function createOrUpdateContact(phoneNumber, firstName, telegramChatId) {
    ...
    try {
        ...
        // ✅ FIX CRÍTICO: Esperar y refrescar para obtener contact_inboxes con source_id
        await sleep(400);
...
// === 🔑 OBTENER SOURCE_ID (✅ FIX: Async con retry) ===
